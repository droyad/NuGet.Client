...
namespace NuGet.Protocol
{
    ...
    {
        public static SourceRepository GetCoreV3(this Repository.RepositoryFactory factory, VersionPackageFolder folder)
        {
            return Repository.CreateSource(Repository.Provider.GetCoreV3(), folder.Path, folder.GetFeedType());
        }
